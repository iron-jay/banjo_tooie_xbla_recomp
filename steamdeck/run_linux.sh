...
export LD_LIBRARY_PATH=/mnt/d/Temp/tooie/rexglue-sdk/out/linux-amd64:${LD_LIBRARY_PATH:-}
...
cd "$BUILD"
exec ./banjotooie --game_data_root /mnt/d/Temp/tooie/xbla/files --log-level debug
