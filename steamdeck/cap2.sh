...
cp /mnt/d/Temp/decomp/launcher/dist/Banjo-Tooie "$T/"; chmod +x "$T/Banjo-Tooie"
cat > "$T/BanjoTooie-Data/launcher_config.xml" <<'EOF'
<?xml version='1.0' encoding='utf-8'?>
<launcher><package_path>/mnt/d/Temp/decomp/ABB9CAB336175357D09F2D922735D23C62F90DDD58</package_path><auto_play>false</auto_play></launcher>
EOF
...
echo "wid ${WID:-none}"; [ -n "$WID" ] && import -window "$WID" /mnt/d/Temp/decomp/steamdeck/launcher_v2.png 2>/dev/null && echo ok
